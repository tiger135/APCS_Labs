public class Money {
    ...
    public void mult(double multiplier) {
        int money_in_cents = dollars*100+cents;
        money_in_cents *= multiplier;
        if (money_in_cents > 99) {
            dollars = money_in_cents / 100;
        }
        cents = money_in_cents%100;

    } // Multiplies total by double factor multiplier.
